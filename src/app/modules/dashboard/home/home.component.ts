...
// import { GroundDetailsService } from '../../../service/ground-details.service';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CommonModule,NavbarComponent,FooterComponent], // Import only the necessary Angular modules
  templateUrl: './home.component.html',
  styleUrls: ['./home.component.css'],
})
export class HomeComponent implements AfterViewInit {
  // constructor(private groundDetailsService: GroundDetailsService) {}
